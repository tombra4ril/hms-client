...
const Laboratorist = () => {
  ...
  useEffect(() => {
    // set page title
    document.title = "Hospital Management System - Laboratorist"
    ...
    let len = Laboratorist.length
    setLaboratorist(Laboratorist)
    setTotal(len)
  ...
  return (
    <div className="section">
      ...
      <div className="content-section">
        <Title name="laboratorist" />
        <div className="bg-gray content-spacing">
          <div className="content-header">
            <ListAdd name="Laboratorist" onContentShow={showContent} />
          </div>
          <div className="content-body">
            {
              ...
              <div className="comp-sect">
                ...
                <table>
                  ...
                  <tbody>
                    {Laboratorist.slice(start, start + numberOfItems).map((nurse, index) => (
                      <tr key={index}>
